...
namespace AOP.Tests.UsingDispatchProxy
{
    ...
    public class LoggingAdviceTests
    {
        ...
        public void LogInfo_WhenMixedParameters()
        {
            ...
            Assert.IsTrue(infoMassages[0].Contains("outParam:null"));
        ...
        public void LogInfoWithProperClassName()
        {
            ...
            Assert.AreEqual(2, infoMassages.Count);
            Assert.IsTrue(infoMassages[0].Contains("Class AOP.Tests.UsingDispatchProxy.TestClass2"));
            Assert.IsTrue(infoMassages[1].Contains("Class AOP.Tests.UsingDispatchProxy.TestClass2"));
            Assert.AreEqual(0, errorMassages.Count);
        }
        ...
        public void LogInfoWithProperStackTrace()
        {
            ...
            Assert.IsTrue(infoMassages[0].Contains("Class AOP.Tests.UsingDispatchProxy.TestClass2"));
            Assert.AreEqual(1, errorMassages.Count);
            Assert.IsTrue(errorMassages[0].Contains("Class AOP.Tests.UsingDispatchProxy.TestClass2"));
